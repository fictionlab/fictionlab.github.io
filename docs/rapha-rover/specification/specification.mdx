...
- `/tf`, `/tf_static` ([tf2_msgs/msg/TFMessage])
  ...
  These topics are used by the [tf2 library](https://docs.ros.org/en/jazzy/Concepts/Intermediate/About-Tf2.html). 
...
[tf2\ library](https://docs.ros.org/en/jazzy/Concepts/Intermediate/About-Tf2.html#tf2)
