...
```bash title="LedColor.msg - represents the color of an LED."
...
```bash title="LedState.msg - represents the state of a single LED."
...
```bash title="LesStripState.msg - represents the state of the whole led strip."
...
```bash title="LedPanel.msg - enumeration of  robot's LEDs panels."
uint8 FRONT=0
uint8 BACK=1
uint8 LEFT=2
uint8 RIGHT=3
...
```bash title="LedPanelState.msg - represents the state of the whole LED panel."
