...
- Adapter plate (eg. the one we provide
  [here](/leo-rover/integrations/addon-adapters#fixposition-vision-rtk2-adapter))
...
in handy in this case. Connecting the power wire straight to the rovers battery
is theoretically possible, but not advised.
...
and follow 4th and 5th chapters, as well as the [quick start guide](https://docs.fixposition.com/fd/quick-start-guide).
