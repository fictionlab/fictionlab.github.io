...
and in a vide range of other applications. Ouster devices excel at 3D scanning
...
sensor dashboard. To do so open your browser of choice and go to address:
**`os-sensor_serial_number.local`**

<ImageZoom
  src="/img/robots/leo/integrations/ouster-os0/ouster_web_interface.webp"
  width="1610"
  height="844"
  figStyle={{
    width: 500,
...
For more information on ouster driver head to its
...
<robot>
    <joint name="ouster_mount_joint" type="fixed">
      ...
      <origin xyz="0 0 0"/> <!--TODO change after mechanical integration-->
    </joint>
...
<ImageZoom
  src="/img/robots/leo/integrations/ouster-os0/ouster_rviz1.webp"
  width="1191"
  height="873"
  figStyle={{
    width: 500,
...
<ImageZoom
  src="/img/robots/leo/integrations/ouster-os0/ouster_rviz2.webp"
  width="1195"
  height="873"
  figStyle={{
    width: 500,
...
<ImageZoom
  src="/img/robots/leo/integrations/ouster-os0/ouster_rviz3.webp"
  width="1195"
  height="872"
  figStyle={{
    width: 500,
