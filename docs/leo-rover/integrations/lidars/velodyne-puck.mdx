...
import CameraMast from '@site/docs/leo-rover/addons/universal-camera-mast/_universal-camera-mast-product.mdx';
...
[Universal Camera Mast](/docs/leo-rover/addons/universal-camera-mast).
...
found [here](/docs/leo-rover/addons/additional-meb-covers), provides a wide
...
[Powerbox](/docs/leo-rover/addons/powerbox) might come in handy in such
situations.
