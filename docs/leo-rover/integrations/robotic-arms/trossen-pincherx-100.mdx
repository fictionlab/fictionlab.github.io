...
<ProductPreview
  shopUrl="https://www.leorover.tech/shop/phantomx-pincher-robot-arm-with-adapters"
  imageSrc="/img/robots/leo/integrations/pincherx-100-mobile/pincher-on-leo.webp"
  width={536}
  height={500}
  title="PincherX 100 Mobile Robot Arm with adapters"
  description="The PincherX 100 Robot Arm, with ROS compatibility and instructional demos,
    enhances Leo Rover's research capabilities, offering 4 degrees of freedom and robust
    construction for AI applications."
/>
...
[here](/leo-rover/integrations/addon-adapters). After printing, it you'll need
to press 4x M3 heat set inserts into the holes shown below.
...
[this tutorial](/leo-rover/advanced-guides/ros-development#building-additional-ros-packages)
