...
<ImageZoom
  src="/img/docs_images/leo-rover/guides/ap-settings/hostapd.webp"
...
Set to indicate country in which the device is operating (regulatory domain). The country codes follow the
