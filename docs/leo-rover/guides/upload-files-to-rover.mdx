...
By default, when logging as `pi` user, you have write permission only on files inside `/home/pi` directory.
This should be sufficient in most cases but if you really need to upload files outside of the home directory you have a couple of options.
