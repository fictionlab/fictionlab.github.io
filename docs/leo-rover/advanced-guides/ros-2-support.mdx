...
<LinkButton
  ...
  description="Flashing a new Raspberry Pi image"
/>
...
As an experimental feature, we added [image_proc] debayer and rectify nodes that
are running by default. They add the following topics:
...
If you used any of our [integrations](/docs/leo-rover/integrations) guides, you
