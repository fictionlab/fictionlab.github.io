...
<Tabs groupId="leo-rover-version">
  <TabItem value='leo-1.8' label='Leo Rover v1.8'>
    <ThemedImageZoom 
      ...
      sources={{
        light: useBaseUrl('/img/docs_images/leo-rover/specification/leo-rover-v1.8_hardware-diagram_black.webp'),
        dark: useBaseUrl('/img/docs_images/leo-rover/specification/leo-rover-v1.8_hardware-diagram_white.webp'),
      }}
      figStyle={{
        width: 800,
      }}
  ...
  <TabItem value='leo-pre1.8' label='Leo Rover < v1.8'>
    <ThemedImageZoom
      ...
      sources={{
        light: useBaseUrl('/img/docs_images/leo-rover/specification/leo-rover-pre1.8_hardware-diagram_black.webp'),
        dark: useBaseUrl('/img/docs_images/leo-rover/specification/leo-rover-pre1.8_hardware-diagram_white.webp'),
      }}
      figStyle={{
        width: 800,
      }}
