...
Leo Rover v1.8 (as well as older Turtle Rover) uses Bühler motors as the wheels actuators.
...
You can always look for different outer diameter tires, but it will change the rover's speed and force (slope/climbing ability).
You can as well find different rubber compounds: softer or tougher ones.
Keep in mind that softer compounds will affect Leo Rover's turning resistance,
but on the other hand, will help it climb obstacles.
...
Stock tires of Leo Rover are similar to these: [Aliexpress](https://www.aliexpress.com/i/32735892787.html)

For example, you can look for tires to switch to here: [RCplanet](https://www.rcplanet.com/1-10-monster-truck-tires/)
