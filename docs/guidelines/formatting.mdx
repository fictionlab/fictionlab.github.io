...
This parameter is used to set a custom order for the documents within categories.
By default, the documents are arranged alphabetically.
...
This parameter defines only the final segment of the slug. The preceding
segments are derived from the file structure.
