...
Image that is displayed as background if user did not clicked to load 3D model. It
is hidden when model is loaded. It is recommended to set it as preview - to show
which model will be show after loading.
