...
Define if product image should be lazy loaded or not. Image should be eager loaded
if it is in the user's initial viewport (visible during page loading). Otherwise
...
Title of the product. It should follow convention - "Product Name | Leo Rover shop"
